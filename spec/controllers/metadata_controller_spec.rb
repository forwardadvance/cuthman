...
describe MetadataController do
  ...
  let(:valid_attributes) { { "page_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved metadatum as @metadatum" do
        ...
        post :create, {:metadatum => { "page_id" => "invalid value" }}, valid_session
        assigns(:metadatum).should be_a_new(Metadatum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested metadatum" do
        ...
        Metadatum.any_instance.should_receive(:update).with({ "page_id" => "1" })
        put :update, {:id => metadatum.to_param, :metadatum => { "page_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the metadatum as @metadatum" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Metadatum.any_instance.stub(:save).and_return(false)
        put :update, {:id => metadatum.to_param, :metadatum => { "page_id" => "invalid value" }}, valid_session
        assigns(:metadatum).should eq(metadatum)
      end
