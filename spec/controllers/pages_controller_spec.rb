...
describe PagesController do
  ...
  let(:valid_attributes) { { "slug" => "MyString" } }
  ...
  #       post :create, {:page => { "slug" => "invalid value" }}, valid_session
  #       assigns(:page).should be_a_new(Page)
  #     end
  ...
  #       Page.any_instance.should_receive(:update).with({ "slug" => "MyString" })
  #       put :update, {:id => page.to_param, :page => { "slug" => "MyString" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Page.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => page.to_param, :page => { "slug" => "invalid value" }}, valid_session
  #       assigns(:page).should eq(page)
  #     end
